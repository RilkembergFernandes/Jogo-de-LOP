  ...
  function preload() {
  pato= loadImage("Idle 001.png")
  fotominha=loadImage("foto pequena para jogo.jpg")
  fotodela=loadImage("images/fotinha da bea .jpeg")  
  
  botaobase=loadImage("KeyboardButtons_Base.png"  )
  
  botao1ceta=loadImage("KeyboardButtons_Basecima.png"  )
    
  ovo=loadImage("egg.png") 
    
  botao2ceta=loadImage( "KeyboardButtons_Basebaixo.png"  )
  
  botao3ceta=loadImage( "KeyboardButtons_Basedireita.png"  )
     
  botao4ceta=loadImage( "KeyboardButtons_Baseesquerda.png"  )
  
  botaoesc=loadImage("esc[2].png")
 
  patinho[0]=loadImage("Running 001.png")
  
  patinho[1]=loadImage("Running 002.png")
  ...
  carro4=loadImage("CarCollection.png")
...
if(mouseX >xdoRetangulo2  && mouseX < xdoRetangulo2+larguradoRetangulo2 && mouseY > ydoRetangulo2  && mouseY < ydoRetangulo2+alturadoRetangulo2){
  ...
  text("SELECIONAR",150,340)
    ...
    if(mouseIsPressed && (mouseX >xdoRetangulo  && mouseX <       xdoRetangulo+larguradoRetangulo && mouseY > ydoRetangulo  && mouseY < ydoRetangulo+alturadoRetangulo)){estado=1;vidas=3;pontos=0
  x=30;y=340 }
